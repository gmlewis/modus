...
func TestArrayOutput_float_1(t *testing.T) {
	...
	// memoryBlockAtOffset(offset: 91936=0x00016720=[32 103 1 0], size: 12=8+words*4), classID=241(Array[Primitive]), words=1, memBlock=[1 0 0 0 241 1 0 0 0 0 128 63]
	result, err := fixture.CallFunction(t, fnName)
	if err != nil {
		t.Fatal(err)
	}
...
func TestArrayOutput_float_2(t *testing.T) {
	...
	// memoryBlockAtOffset(offset: 91936=0x00016720=[32 103 1 0], size: 16=8+words*4), classID=241(Array[Primitive]), words=2, memBlock=[1 0 0 0 241 2 0 0 0 0 128 63 0 0 0 64]
	result, err := fixture.CallFunction(t, fnName)
	if err != nil {
		t.Fatal(err)
	}
...
func TestArrayOutput_float_3(t *testing.T) {
	...
	// memoryBlockAtOffset(offset: 91936=0x00016720=[32 103 1 0], size: 20=8+words*4), classID=241(Array[Primitive]), words=3, memBlock=[1 0 0 0 241 3 0 0 0 0 128 63 0 0 0 64 0 0 64 64]
	result, err := fixture.CallFunction(t, fnName)
	if err != nil {
		t.Fatal(err)
	}
...
func TestArrayOutput_float_4(t *testing.T) {
	...
	// memoryBlockAtOffset(offset: 91936=0x00016720=[32 103 1 0], size: 24=8+words*4), classID=241(Array[Primitive]), words=4, memBlock=[1 0 0 0 241 4 0 0 0 0 128 63 0 0 0 64 0 0 64 64 0 0 128 64]
	result, err := fixture.CallFunction(t, fnName)
	if err != nil {
		t.Fatal(err)
	}
