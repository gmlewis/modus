...
var wantPackageTestsuite = &Package{
	...
	TypesInfo: &types.Info{
		Defs: map[*ast.Ident]types.Object{
			...
			{Name: "test_array_output_int_option"}:                    &moonFunc{funcName: "func @test-suite.test_array_output_int_option() Array[Int?]"},
			{Name: "make_test_map"}:                                   &moonFunc{funcName: "func @test-suite.make_test_map(size Int) Map[String, String]"},
			...
			{Name: "test_tuple_simulator"}:                            &moonFunc{funcName: "func @test-suite.test_tuple_simulator() TupleSimulator"},
			...
			{Name: "test_time_option_input"}:                          &moonFunc{funcName: "func @test-suite.test_time_option_input(t @time.ZonedDateTime?) Unit!Error"},
			{Name: "hello_array_of_ints_option"}:                      &moonFunc{funcName: "func @test-suite.hello_array_of_ints_option(n~ Int) Array[Int]?"},
			{Name: "test_array_output_string_option"}:                 &moonFunc{funcName: "func @test-suite.test_array_output_string_option() Array[String?]"},
			{Name: "test_map_output_int_double"}:                      &moonFunc{funcName: "func @test-suite.test_map_output_int_double() Map[Int, Double]"},
			...
			{Name: "test_map_input_string_string"}:                    &moonFunc{funcName: "func @test-suite.test_map_input_string_string(m Map[String, String]) Unit!Error"},
			...
			{Name: "test_struct_containing_map_output_string_string"}: &moonFunc{funcName: "func @test-suite.test_struct_containing_map_output_string_string() TestStructWithMap"},
			...
			{Name: "test_time_input"}:                                 &moonFunc{funcName: "func @test-suite.test_time_input(t @time.ZonedDateTime) Unit!Error"},
			{Name: "hello_maps_n_items_WithDefaults"}:                 &moonFunc{funcName: "func @test-suite.hello_maps_n_items_WithDefaults() Map[String, String]"},
			{Name: "test_map_option_output_string_string"}:            &moonFunc{funcName: "func @test-suite.test_map_option_output_string_string() Map[String, String]?"},
			{Name: "test_map_input_int_float"}:                        &moonFunc{funcName: "func @test-suite.test_map_input_int_float(m Map[Int, Float]) Unit!Error"},
			...
			{Name: "test_map_output_string_string"}:                   &moonFunc{funcName: "func @test-suite.test_map_output_string_string() Map[String, String]"},
			...
			{Name: "test_tuple_output"}:                               &moonFunc{funcName: "func @test-suite.test_tuple_output() (Int, Bool, String)"},
			{Name: "test_array_input_string"}:                         &moonFunc{funcName: "func @test-suite.test_array_input_string(val Array[String]) Unit!Error"},
			{Name: "test_map_lookup_string_string"}:                   &moonFunc{funcName: "func @test-suite.test_map_lookup_string_string(m Map[String, String], key String) String"},
			{Name: "test_struct_containing_map_input_string_string"}:  &moonFunc{funcName: "func @test-suite.test_struct_containing_map_input_string_string(s TestStructWithMap) Unit!Error"},
			...
			{Name: "test_iterate_map_string_string"}:                  &moonFunc{funcName: "func @test-suite.test_iterate_map_string_string(m Map[String, String])"},
			...
			{Name: "call_test_time_option_input_some"}:                &moonFunc{funcName: "func @test-suite.call_test_time_option_input_some() Unit!Error"},
			...
			{Name: "test_map_option_input_string_string"}:             &moonFunc{funcName: "func @test-suite.test_map_option_input_string_string(m Map[String, String]?) Unit!Error"},
			{Name: "test_map_output_int_float"}:                       &moonFunc{funcName: "func @test-suite.test_map_output_int_float() Map[Int, Float]"},
			{Name: "test_map_input_int_double"}:                       &moonFunc{funcName: "func @test-suite.test_map_input_int_double(m Map[Int, Double]) Unit!Error"},
		},
	},
}
