...
var wantPackageTestsuite = &Package{
	...
	TypesInfo: &types.Info{
		Defs: map[*ast.Ident]types.Object{
			...
			{Name: "hello_array_of_ints"}:                             &moonFunc{funcName: "func hello_array_of_ints(n~ Int) Array[Int]"},
			...
			{Name: "hello_array_of_strings_option"}:                   &moonFunc{funcName: "func hello_array_of_strings_option(n~ Int) Array[String]?"},
			...
			{Name: "add3"}:                                            &moonFunc{funcName: "func add3(a Int, b Int, c~ Int) Int"},
			...
			{Name: "hello_option_none"}:                               &moonFunc{funcName: "func hello_option_none(some~ Bool) String?"},
			...
			{Name: "hello_array_of_ints_option"}:                      &moonFunc{funcName: "func hello_array_of_ints_option(n~ Int) Array[Int]?"},
			...
			{Name: "hello_array_of_strings"}:                          &moonFunc{funcName: "func hello_array_of_strings(n~ Int) Array[String]"},
			...
			{Name: "hello_maps_n_items"}:                              &moonFunc{funcName: "func hello_maps_n_items(n~ Int) Map[String, String]"},
			...
			{Name: "hello_option_empty_string"}:                       &moonFunc{funcName: "func hello_option_empty_string(some~ Bool) String?"},
			...
			{Name: "hello_option_some_string"}:                        &moonFunc{funcName: "func hello_option_some_string(some~ Bool) String?"},
			...
			{Name: "hello_world_with_optional_arg"}:                   &moonFunc{funcName: "func hello_world_with_optional_arg(name~ String) String"},
			...
			{Name: "hello_maps_n_items_option"}:                       &moonFunc{funcName: "func hello_maps_n_items_option(n~ Int) Map[String, String]?"},
