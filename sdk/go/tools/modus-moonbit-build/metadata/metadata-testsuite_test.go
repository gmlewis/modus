// -*- compile-command: "NO_COLOR=1 go test -run ^TestFunction_String_Testsuite$ ."; -*-
...
func TestFunction_String_Testsuite(t *testing.T) {
	...
	tests := []functionStringTest{
		...
		{name: "call_test_time_option_input_some", want: "() -> Unit raise Error"},
		...
		{name: "get_local_time", want: "() -> String raise Error"},
		...
		{name: "get_time_in_zone", want: "(tz : String) -> String raise Error"},
		...
		{name: "test_array_input_string", want: "(val : Array[String]) -> Unit raise Error"},
		...
		{name: "test_map_input_int_double", want: "(m : Map[Int, Double]) -> Unit raise Error"},
		{name: "test_map_input_int_float", want: "(m : Map[Int, Float]) -> Unit raise Error"},
		{name: "test_map_input_string_string", want: "(m : Map[String, String]) -> Unit raise Error"},
		{name: "test_map_lookup_string_string", want: "(m : Map[String, String], key : String) -> String"},
		{name: "test_map_option_input_string_string", want: "(m : Map[String, String]?) -> Unit raise Error"},
		...
		{name: "test_struct_containing_map_input_string_string", want: "(s : TestStructWithMap) -> Unit raise Error"},
		{name: "test_struct_containing_map_output_string_string", want: "() -> TestStructWithMap"},
		{name: "test_time_input", want: "(t : @time.ZonedDateTime) -> Unit raise Error"},
		{name: "test_time_option_input", want: "(t : @time.ZonedDateTime?) -> Unit raise Error"},
