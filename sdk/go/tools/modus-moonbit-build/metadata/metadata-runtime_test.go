...
func TestFunction_String_Runtime(t *testing.T) {
	...
	tests := []functionStringTest{
		...
		{name: "test_recursive_struct_input", want: "(r1 : TestRecursiveStruct) -> Unit!Error"},
		...
		{name: "test_smorgasbord_struct_input", want: "(o : TestSmorgasbordStruct) -> Unit!Error"},
		{name: "test_smorgasbord_struct_option_input", want: "(o : TestSmorgasbordStruct?) -> Unit!Error"},
		{name: "test_smorgasbord_struct_option_input_none", want: "(o : TestSmorgasbordStruct?) -> Unit!Error"},
