// -*- compile-command: "NO_COLOR=1 go test -run ^TestFunction_String_Runtime$ ."; -*-
...
func TestFunction_String_Runtime(t *testing.T) {
	...
	tests := []functionStringTest{
		...
		{name: "test2d_array_input_string", want: "(val : Array[Array[String]]) -> Unit raise Error"},
		{name: "test2d_array_input_string_empty", want: "(val : Array[Array[String]]) -> Unit raise Error"},
		{name: "test2d_array_input_string_inner_empty", want: "(val : Array[Array[String]]) -> Unit raise Error"},
		{name: "test2d_array_input_string_inner_none", want: "(val : Array[Array[String]?]) -> Unit raise Error"},
		{name: "test2d_array_input_string_none", want: "(val : Array[Array[String]]?) -> Unit raise Error"},
		...
		{name: "test_array_input_bool_0", want: "(val : Array[Bool]) -> Unit raise Error"},
		{name: "test_array_input_bool_1", want: "(val : Array[Bool]) -> Unit raise Error"},
		{name: "test_array_input_bool_2", want: "(val : Array[Bool]) -> Unit raise Error"},
		{name: "test_array_input_bool_3", want: "(val : Array[Bool]) -> Unit raise Error"},
		{name: "test_array_input_bool_4", want: "(val : Array[Bool]) -> Unit raise Error"},
		{name: "test_array_input_bool_option_0", want: "(val : Array[Bool?]) -> Unit raise Error"},
		{name: "test_array_input_bool_option_1_false", want: "(val : Array[Bool?]) -> Unit raise Error"},
		{name: "test_array_input_bool_option_1_none", want: "(val : Array[Bool?]) -> Unit raise Error"},
		{name: "test_array_input_bool_option_1_true", want: "(val : Array[Bool?]) -> Unit raise Error"},
		{name: "test_array_input_bool_option_2", want: "(val : Array[Bool?]) -> Unit raise Error"},
		{name: "test_array_input_bool_option_3", want: "(val : Array[Bool?]) -> Unit raise Error"},
		{name: "test_array_input_bool_option_4", want: "(val : Array[Bool?]) -> Unit raise Error"},
		{name: "test_array_input_byte_0", want: "(val : Array[Byte]) -> Unit raise Error"},
		{name: "test_array_input_byte_1", want: "(val : Array[Byte]) -> Unit raise Error"},
		{name: "test_array_input_byte_2", want: "(val : Array[Byte]) -> Unit raise Error"},
		{name: "test_array_input_byte_3", want: "(val : Array[Byte]) -> Unit raise Error"},
		{name: "test_array_input_byte_4", want: "(val : Array[Byte]) -> Unit raise Error"},
		{name: "test_array_input_byte_option_0", want: "(val : Array[Byte?]) -> Unit raise Error"},
		{name: "test_array_input_byte_option_1", want: "(val : Array[Byte?]) -> Unit raise Error"},
		{name: "test_array_input_byte_option_2", want: "(val : Array[Byte?]) -> Unit raise Error"},
		{name: "test_array_input_byte_option_3", want: "(val : Array[Byte?]) -> Unit raise Error"},
		{name: "test_array_input_byte_option_4", want: "(val : Array[Byte?]) -> Unit raise Error"},
		{name: "test_array_input_char_empty", want: "(val : Array[Char]) -> Unit raise Error"},
		{name: "test_array_input_char_option", want: "(val : Array[Char?]) -> Unit raise Error"},
		{name: "test_array_input_double_empty", want: "(val : Array[Double]) -> Unit raise Error"},
		{name: "test_array_input_double_option", want: "(val : Array[Double?]) -> Unit raise Error"},
		{name: "test_array_input_float_empty", want: "(val : Array[Float]) -> Unit raise Error"},
		{name: "test_array_input_float_option", want: "(val : Array[Float?]) -> Unit raise Error"},
		{name: "test_array_input_int16_empty", want: "(val : Array[Int16]) -> Unit raise Error"},
		{name: "test_array_input_int16_option", want: "(val : Array[Int16?]) -> Unit raise Error"},
		{name: "test_array_input_int_empty", want: "(val : Array[Int]) -> Unit raise Error"},
		{name: "test_array_input_int_option", want: "(val : Array[Int?]) -> Unit raise Error"},
		{name: "test_array_input_string", want: "(val : Array[String]) -> Unit raise Error"},
		{name: "test_array_input_string_empty", want: "(val : Array[String]) -> Unit raise Error"},
		{name: "test_array_input_string_none", want: "(val : Array[String]?) -> Unit raise Error"},
		{name: "test_array_input_string_option", want: "(val : Array[String?]) -> Unit raise Error"},
		{name: "test_array_input_uint16_empty", want: "(val : Array[UInt16]) -> Unit raise Error"},
		{name: "test_array_input_uint16_option", want: "(val : Array[UInt16?]) -> Unit raise Error"},
		{name: "test_array_input_uint_empty", want: "(val : Array[UInt]) -> Unit raise Error"},
		{name: "test_array_input_uint_option", want: "(val : Array[UInt?]) -> Unit raise Error"},
		...
		{name: "test_bool_input_false", want: "(b : Bool) -> Unit raise Error"},
		{name: "test_bool_input_true", want: "(b : Bool) -> Unit raise Error"},
		{name: "test_bool_option_input_false", want: "(b : Bool?) -> Unit raise Error"},
		{name: "test_bool_option_input_none", want: "(b : Bool?) -> Unit raise Error"},
		{name: "test_bool_option_input_true", want: "(b : Bool?) -> Unit raise Error"},
		...
		{name: "test_byte_input_max", want: "(b : Byte) -> Unit raise Error"},
		{name: "test_byte_input_min", want: "(b : Byte) -> Unit raise Error"},
		{name: "test_byte_option_input_max", want: "(b : Byte?) -> Unit raise Error"},
		{name: "test_byte_option_input_min", want: "(b : Byte?) -> Unit raise Error"},
		{name: "test_byte_option_input_none", want: "(b : Byte?) -> Unit raise Error"},
		...
		{name: "test_char_input_max", want: "(c : Char) -> Unit raise Error"},
		{name: "test_char_input_min", want: "(c : Char) -> Unit raise Error"},
		{name: "test_char_option_input_max", want: "(c : Char?) -> Unit raise Error"},
		{name: "test_char_option_input_min", want: "(c : Char?) -> Unit raise Error"},
		{name: "test_char_option_input_none", want: "(c : Char?) -> Unit raise Error"},
		...
		{name: "test_double_input_max", want: "(n : Double) -> Unit raise Error"},
		{name: "test_double_input_min", want: "(n : Double) -> Unit raise Error"},
		{name: "test_double_option_input_max", want: "(n : Double?) -> Unit raise Error"},
		{name: "test_double_option_input_min", want: "(n : Double?) -> Unit raise Error"},
		{name: "test_double_option_input_none", want: "(n : Double?) -> Unit raise Error"},
		...
		{name: "test_duration_input", want: "(d : @time.Duration) -> Unit raise Error"},
		{name: "test_duration_option_input", want: "(d : @time.Duration?) -> Unit raise Error"},
		{name: "test_duration_option_input_none", want: "(d : @time.Duration?) -> Unit raise Error"},
		{name: "test_duration_option_input_none_style2", want: "(d? : @time.Duration) -> Unit raise Error"},
		{name: "test_duration_option_input_style2", want: "(d? : @time.Duration) -> Unit raise Error"},
		...
		{name: "test_fixedarray_input0_byte", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input0_int_option", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input0_string", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input0_string_option", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input1_byte", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input1_int_option", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input1_string", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input1_string_option", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_byte", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_int_option", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_map", want: "(val : FixedArray[Map[String, String]]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_map_option", want: "(val : FixedArray[Map[String, String]?]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_string", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_string_option", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_struct", want: "(val : FixedArray[TestStruct2]) -> Unit raise Error"},
		{name: "test_fixedarray_input2_struct_option", want: "(val : FixedArray[TestStruct2?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_0", want: "(val : FixedArray[Bool]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_1", want: "(val : FixedArray[Bool]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_2", want: "(val : FixedArray[Bool]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_3", want: "(val : FixedArray[Bool]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_4", want: "(val : FixedArray[Bool]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_option_0", want: "(val : FixedArray[Bool?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_option_1_false", want: "(val : FixedArray[Bool?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_option_1_none", want: "(val : FixedArray[Bool?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_option_1_true", want: "(val : FixedArray[Bool?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_option_2", want: "(val : FixedArray[Bool?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_option_3", want: "(val : FixedArray[Bool?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_bool_option_4", want: "(val : FixedArray[Bool?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_0", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_1", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_2", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_3", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_4", want: "(val : FixedArray[Byte]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_option_0", want: "(val : FixedArray[Byte?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_option_1", want: "(val : FixedArray[Byte?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_option_2", want: "(val : FixedArray[Byte?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_option_3", want: "(val : FixedArray[Byte?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_byte_option_4", want: "(val : FixedArray[Byte?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_0", want: "(val : FixedArray[Char]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_1", want: "(val : FixedArray[Char]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_2", want: "(val : FixedArray[Char]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_3", want: "(val : FixedArray[Char]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_4", want: "(val : FixedArray[Char]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_option_0", want: "(val : FixedArray[Char?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_option_1_none", want: "(val : FixedArray[Char?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_option_1_some", want: "(val : FixedArray[Char?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_option_2", want: "(val : FixedArray[Char?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_option_3", want: "(val : FixedArray[Char?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_char_option_4", want: "(val : FixedArray[Char?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_0", want: "(val : FixedArray[Double]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_1", want: "(val : FixedArray[Double]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_2", want: "(val : FixedArray[Double]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_3", want: "(val : FixedArray[Double]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_4", want: "(val : FixedArray[Double]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_option_0", want: "(val : FixedArray[Double?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_option_1_none", want: "(val : FixedArray[Double?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_option_1_some", want: "(val : FixedArray[Double?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_option_2", want: "(val : FixedArray[Double?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_option_3", want: "(val : FixedArray[Double?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_double_option_4", want: "(val : FixedArray[Double?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_0", want: "(val : FixedArray[Float]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_1", want: "(val : FixedArray[Float]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_2", want: "(val : FixedArray[Float]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_3", want: "(val : FixedArray[Float]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_4", want: "(val : FixedArray[Float]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_option_0", want: "(val : FixedArray[Float?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_option_1_none", want: "(val : FixedArray[Float?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_option_1_some", want: "(val : FixedArray[Float?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_option_2", want: "(val : FixedArray[Float?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_option_3", want: "(val : FixedArray[Float?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_float_option_4", want: "(val : FixedArray[Float?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_0", want: "(val : FixedArray[Int16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_1", want: "(val : FixedArray[Int16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_1_max", want: "(val : FixedArray[Int16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_1_min", want: "(val : FixedArray[Int16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_2", want: "(val : FixedArray[Int16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_3", want: "(val : FixedArray[Int16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_4", want: "(val : FixedArray[Int16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_option_0", want: "(val : FixedArray[Int16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_option_1_max", want: "(val : FixedArray[Int16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_option_1_min", want: "(val : FixedArray[Int16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_option_1_none", want: "(val : FixedArray[Int16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_option_2", want: "(val : FixedArray[Int16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_option_3", want: "(val : FixedArray[Int16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int16_option_4", want: "(val : FixedArray[Int16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_0", want: "(val : FixedArray[Int64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_1", want: "(val : FixedArray[Int64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_1_max", want: "(val : FixedArray[Int64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_1_min", want: "(val : FixedArray[Int64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_2", want: "(val : FixedArray[Int64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_3", want: "(val : FixedArray[Int64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_4", want: "(val : FixedArray[Int64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_option_0", want: "(val : FixedArray[Int64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_option_1_max", want: "(val : FixedArray[Int64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_option_1_min", want: "(val : FixedArray[Int64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_option_1_none", want: "(val : FixedArray[Int64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_option_2", want: "(val : FixedArray[Int64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_option_3", want: "(val : FixedArray[Int64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int64_option_4", want: "(val : FixedArray[Int64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_0", want: "(val : FixedArray[Int]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_1", want: "(val : FixedArray[Int]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_1_max", want: "(val : FixedArray[Int]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_1_min", want: "(val : FixedArray[Int]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_2", want: "(val : FixedArray[Int]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_3", want: "(val : FixedArray[Int]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_4", want: "(val : FixedArray[Int]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_option_0", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_option_1_max", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_option_1_min", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_option_1_none", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_option_2", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_option_3", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_int_option_4", want: "(val : FixedArray[Int?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_0", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_1", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_2", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_3", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_4", want: "(val : FixedArray[String]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_option_0", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_option_1_none", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_option_1_some", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_option_2", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_option_3", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_string_option_4", want: "(val : FixedArray[String?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_0", want: "(val : FixedArray[UInt16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_1", want: "(val : FixedArray[UInt16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_1_max", want: "(val : FixedArray[UInt16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_1_min", want: "(val : FixedArray[UInt16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_2", want: "(val : FixedArray[UInt16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_3", want: "(val : FixedArray[UInt16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_4", want: "(val : FixedArray[UInt16]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_option_0", want: "(val : FixedArray[UInt16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_option_1_max", want: "(val : FixedArray[UInt16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_option_1_min", want: "(val : FixedArray[UInt16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_option_1_none", want: "(val : FixedArray[UInt16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_option_2", want: "(val : FixedArray[UInt16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_option_3", want: "(val : FixedArray[UInt16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint16_option_4", want: "(val : FixedArray[UInt16?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_0", want: "(val : FixedArray[UInt64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_1", want: "(val : FixedArray[UInt64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_1_max", want: "(val : FixedArray[UInt64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_1_min", want: "(val : FixedArray[UInt64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_2", want: "(val : FixedArray[UInt64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_3", want: "(val : FixedArray[UInt64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_4", want: "(val : FixedArray[UInt64]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_option_0", want: "(val : FixedArray[UInt64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_option_1_max", want: "(val : FixedArray[UInt64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_option_1_min", want: "(val : FixedArray[UInt64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_option_1_none", want: "(val : FixedArray[UInt64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_option_2", want: "(val : FixedArray[UInt64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_option_3", want: "(val : FixedArray[UInt64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint64_option_4", want: "(val : FixedArray[UInt64?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_0", want: "(val : FixedArray[UInt]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_1", want: "(val : FixedArray[UInt]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_1_max", want: "(val : FixedArray[UInt]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_1_min", want: "(val : FixedArray[UInt]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_2", want: "(val : FixedArray[UInt]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_3", want: "(val : FixedArray[UInt]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_4", want: "(val : FixedArray[UInt]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_option_0", want: "(val : FixedArray[UInt?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_option_1_max", want: "(val : FixedArray[UInt?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_option_1_min", want: "(val : FixedArray[UInt?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_option_1_none", want: "(val : FixedArray[UInt?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_option_2", want: "(val : FixedArray[UInt?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_option_3", want: "(val : FixedArray[UInt?]) -> Unit raise Error"},
		{name: "test_fixedarray_input_uint_option_4", want: "(val : FixedArray[UInt?]) -> Unit raise Error"},
		...
		{name: "test_float_input_max", want: "(n : Float) -> Unit raise Error"},
		{name: "test_float_input_min", want: "(n : Float) -> Unit raise Error"},
		{name: "test_float_option_input_max", want: "(n : Float?) -> Unit raise Error"},
		{name: "test_float_option_input_min", want: "(n : Float?) -> Unit raise Error"},
		{name: "test_float_option_input_none", want: "(n : Float?) -> Unit raise Error"},
		...
		{name: "test_http_response_headers_output", want: "() -> HttpResponse?"},
		{name: "test_int16_input_max", want: "(n : Int16) -> Unit raise Error"},
		{name: "test_int16_input_min", want: "(n : Int16) -> Unit raise Error"},
		{name: "test_int16_option_input_max", want: "(n : Int16?) -> Unit raise Error"},
		{name: "test_int16_option_input_min", want: "(n : Int16?) -> Unit raise Error"},
		{name: "test_int16_option_input_none", want: "(n : Int16?) -> Unit raise Error"},
		...
		{name: "test_int64_input_max", want: "(n : Int64) -> Unit raise Error"},
		{name: "test_int64_input_min", want: "(n : Int64) -> Unit raise Error"},
		{name: "test_int64_option_input_max", want: "(n : Int64?) -> Unit raise Error"},
		{name: "test_int64_option_input_min", want: "(n : Int64?) -> Unit raise Error"},
		{name: "test_int64_option_input_none", want: "(n : Int64?) -> Unit raise Error"},
		...
		{name: "test_int_input_max", want: "(n : Int) -> Unit raise Error"},
		{name: "test_int_input_min", want: "(n : Int) -> Unit raise Error"},
		{name: "test_int_option_input_max", want: "(n : Int?) -> Unit raise Error"},
		{name: "test_int_option_input_min", want: "(n : Int?) -> Unit raise Error"},
		{name: "test_int_option_input_none", want: "(n : Int?) -> Unit raise Error"},
		...
		{name: "test_option_fixedarray_input1_int", want: "(val : FixedArray[Int]?) -> Unit raise Error"},
		{name: "test_option_fixedarray_input1_string", want: "(val : FixedArray[String]?) -> Unit raise Error"},
		{name: "test_option_fixedarray_input2_int", want: "(val : FixedArray[Int]?) -> Unit raise Error"},
		{name: "test_option_fixedarray_input2_string", want: "(val : FixedArray[String]?) -> Unit raise Error"},
		...
		{name: "test_recursive_struct_input", want: "(r1 : TestRecursiveStruct) -> Unit raise Error"},
		{name: "test_recursive_struct_option_input", want: "(o : TestRecursiveStruct?) -> Unit raise Error"},
		{name: "test_recursive_struct_option_input_none", want: "(o : TestRecursiveStruct?) -> Unit raise Error"},
		...
		{name: "test_smorgasbord_struct_input", want: "(o : TestSmorgasbordStruct) -> Unit raise Error"},
		{name: "test_smorgasbord_struct_option_input", want: "(o : TestSmorgasbordStruct?) -> Unit raise Error"},
		{name: "test_smorgasbord_struct_option_input_none", want: "(o : TestSmorgasbordStruct?) -> Unit raise Error"},
		{name: "test_smorgasbord_struct_option_output", want: "() -> TestSmorgasbordStruct?"},
		{name: "test_smorgasbord_struct_option_output_map", want: "() -> TestSmorgasbordStruct_map?"},
		{name: "test_smorgasbord_struct_option_output_map_none", want: "() -> TestSmorgasbordStruct_map?"},
		{name: "test_smorgasbord_struct_option_output_none", want: "() -> TestSmorgasbordStruct?"},
		{name: "test_smorgasbord_struct_output", want: "() -> TestSmorgasbordStruct"},
		{name: "test_smorgasbord_struct_output_map", want: "() -> TestSmorgasbordStruct_map"},
		{name: "test_string_input", want: "(s : String) -> Unit raise Error"},
		{name: "test_string_option_input", want: "(s : String?) -> Unit raise Error"},
		{name: "test_string_option_input_none", want: "(s : String?) -> Unit raise Error"},
		...
		{name: "test_struct_input1", want: "(o : TestStruct1) -> Unit raise Error"},
		{name: "test_struct_input2", want: "(o : TestStruct2) -> Unit raise Error"},
		{name: "test_struct_input3", want: "(o : TestStruct3) -> Unit raise Error"},
		{name: "test_struct_input4", want: "(o : TestStruct4) -> Unit raise Error"},
		{name: "test_struct_input4_with_none", want: "(o : TestStruct4) -> Unit raise Error"},
		{name: "test_struct_input5", want: "(o : TestStruct5) -> Unit raise Error"},
		{name: "test_struct_option_input1", want: "(o : TestStruct1?) -> Unit raise Error"},
		{name: "test_struct_option_input1_none", want: "(o : TestStruct1?) -> Unit raise Error"},
		{name: "test_struct_option_input2", want: "(o : TestStruct2?) -> Unit raise Error"},
		{name: "test_struct_option_input2_none", want: "(o : TestStruct2?) -> Unit raise Error"},
		{name: "test_struct_option_input3", want: "(o : TestStruct3?) -> Unit raise Error"},
		{name: "test_struct_option_input3_none", want: "(o : TestStruct3?) -> Unit raise Error"},
		{name: "test_struct_option_input4", want: "(o : TestStruct4?) -> Unit raise Error"},
		{name: "test_struct_option_input4_none", want: "(o : TestStruct4?) -> Unit raise Error"},
		{name: "test_struct_option_input4_with_none", want: "(o : TestStruct4?) -> Unit raise Error"},
		{name: "test_struct_option_input5", want: "(o : TestStruct5?) -> Unit raise Error"},
		{name: "test_struct_option_input5_none", want: "(o : TestStruct5?) -> Unit raise Error"},
		...
		{name: "test_time_option_input_none", want: "(t : @time.ZonedDateTime?) -> Unit raise Error"},
		{name: "test_time_option_input_none_style2", want: "(t? : @time.ZonedDateTime) -> Unit raise Error"},
		{name: "test_time_option_input_style2", want: "(t? : @time.ZonedDateTime) -> Unit raise Error"},
		...
		{name: "test_uint16_input_max", want: "(n : UInt16) -> Unit raise Error"},
		{name: "test_uint16_input_min", want: "(n : UInt16) -> Unit raise Error"},
		{name: "test_uint16_option_input_max", want: "(n : UInt16?) -> Unit raise Error"},
		{name: "test_uint16_option_input_min", want: "(n : UInt16?) -> Unit raise Error"},
		{name: "test_uint16_option_input_none", want: "(n : UInt16?) -> Unit raise Error"},
		...
		{name: "test_uint64_input_max", want: "(n : UInt64) -> Unit raise Error"},
		{name: "test_uint64_input_min", want: "(n : UInt64) -> Unit raise Error"},
		{name: "test_uint64_option_input_max", want: "(n : UInt64?) -> Unit raise Error"},
		{name: "test_uint64_option_input_min", want: "(n : UInt64?) -> Unit raise Error"},
		{name: "test_uint64_option_input_none", want: "(n : UInt64?) -> Unit raise Error"},
		...
		{name: "test_uint_input_max", want: "(n : UInt) -> Unit raise Error"},
		{name: "test_uint_input_min", want: "(n : UInt) -> Unit raise Error"},
		{name: "test_uint_option_input_max", want: "(n : UInt?) -> Unit raise Error"},
		{name: "test_uint_option_input_min", want: "(n : UInt?) -> Unit raise Error"},
		{name: "test_uint_option_input_none", want: "(n : UInt?) -> Unit raise Error"},
