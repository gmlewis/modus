...
func TestFunction_String_Simple(t *testing.T) {
	...
	tests := []functionStringTest{
		...
		{name: "get_current_time_WithDefaults", want: "() -> @time.ZonedDateTime!Error"},
		{name: "get_current_time_formatted", want: "(now~ : @wallClock.Datetime) -> String!Error"},
		{name: "get_current_time_formatted_WithDefaults", want: "() -> String!Error"},
		...
		{name: "say_hello_WithDefaults", want: "() -> String"},
