...
var wantRuntimeTypes = metadata.TypeMap{
	...
	"Int":                      {Id: 46, Name: "Int"},
	"Int16":                    {Id: 47, Name: "Int16"},
	"Int16?":                   {Id: 48, Name: "Int16?"},
	"Int64":                    {Id: 49, Name: "Int64"},
	"Int64?":                   {Id: 50, Name: "Int64?"},
	"Int?":                     {Id: 51, Name: "Int?"},
	"Map[Int, Double]":         {Id: 52, Name: "Map[Int, Double]"},
	"Map[String, HttpHeader?]": {Id: 53, Name: "Map[String, HttpHeader?]"},
	"Map[String, String]":      {Id: 54, Name: "Map[String, String]"},
	"Map[String, String]?":     {Id: 55, Name: "Map[String, String]?"},
	"String":                   {Id: 56, Name: "String"},
	"String?":                  {Id: 57, Name: "String?"},
	"TestRecursiveStruct": {Id: 58,
	...
	"TestStructWithMap": {Id: 82,
		Name:   "TestStructWithMap",
		Fields: []*metadata.Field{{Name: "m", Type: "Map[String, String]"}},
	},
	"UInt":       {Id: 83, Name: "UInt"},
	"UInt16":     {Id: 84, Name: "UInt16"},
	"UInt16?":    {Id: 85, Name: "UInt16?"},
	"UInt64":     {Id: 86, Name: "UInt64"},
	"UInt64?":    {Id: 87, Name: "UInt64?"},
	"UInt?":      {Id: 88, Name: "UInt?"},
	"Unit":       {Id: 89, Name: "Unit"},
	"Unit!Error": {Id: 90, Name: "Unit!Error"},
}
