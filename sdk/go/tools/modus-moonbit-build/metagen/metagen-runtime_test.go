...
var wantRuntimeTypes = metadata.TypeMap{
	...
	"FixedArray[Map[String, String]?]": {Id: 43, Name: "FixedArray[Map[String, String]?]"},
	"FixedArray[Map[String, String]]":  {Id: 44, Name: "FixedArray[Map[String, String]]"},
	"FixedArray[String?]":              {Id: 45, Name: "FixedArray[String?]"},
	"FixedArray[String]":               {Id: 46, Name: "FixedArray[String]"},
	"FixedArray[String]?":              {Id: 47, Name: "FixedArray[String]?"},
	"FixedArray[TestStruct2?]":         {Id: 48, Name: "FixedArray[TestStruct2?]"},
	"FixedArray[TestStruct2]":          {Id: 49, Name: "FixedArray[TestStruct2]"},
	"Float":                            {Id: 50, Name: "Float"},
	"Float?":                           {Id: 51, Name: "Float?"},
	"HttpHeader?":                      {Id: 52, Name: "HttpHeader?"},
	"HttpHeaders":                      {Id: 53, Name: "HttpHeaders"},
	"HttpResponse?":                    {Id: 54, Name: "HttpResponse?"},
	"Int":                              {Id: 55, Name: "Int"},
	"Int16":                            {Id: 56, Name: "Int16"},
	"Int16?":                           {Id: 57, Name: "Int16?"},
	"Int64":                            {Id: 58, Name: "Int64"},
	"Int64?":                           {Id: 59, Name: "Int64?"},
	"Int?":                             {Id: 60, Name: "Int?"},
	"Map[Int, Double]":                 {Id: 61, Name: "Map[Int, Double]"},
	"Map[String, HttpHeader?]":         {Id: 62, Name: "Map[String, HttpHeader?]"},
	"Map[String, String]":              {Id: 63, Name: "Map[String, String]"},
	"Map[String, String]?":             {Id: 64, Name: "Map[String, String]?"},
	"String?":                          {Id: 65, Name: "String?"},
	"TestRecursiveStruct":              {Id: 66, Name: "TestRecursiveStruct"},
	"TestRecursiveStruct?":             {Id: 67, Name: "TestRecursiveStruct?"},
	"TestRecursiveStruct_map?":         {Id: 68, Name: "TestRecursiveStruct_map?"},
	"TestStruct1":                      {Id: 69, Name: "TestStruct1"},
	"TestStruct1?":                     {Id: 70, Name: "TestStruct1?"},
	"TestStruct1_map?":                 {Id: 71, Name: "TestStruct1_map?"},
	"TestStruct2":                      {Id: 72, Name: "TestStruct2"},
	"TestStruct2?":                     {Id: 73, Name: "TestStruct2?"},
	"TestStruct2_map?":                 {Id: 74, Name: "TestStruct2_map?"},
	"TestStruct3":                      {Id: 75, Name: "TestStruct3"},
	"TestStruct3?":                     {Id: 76, Name: "TestStruct3?"},
	"TestStruct3_map?":                 {Id: 77, Name: "TestStruct3_map?"},
	"TestStruct4":                      {Id: 78, Name: "TestStruct4"},
	"TestStruct4?":                     {Id: 79, Name: "TestStruct4?"},
	"TestStruct4_map?":                 {Id: 80, Name: "TestStruct4_map?"},
	"TestStruct5":                      {Id: 81, Name: "TestStruct5"},
	"TestStruct5?":                     {Id: 82, Name: "TestStruct5?"},
	"TestStruct5_map?":                 {Id: 83, Name: "TestStruct5_map?"},
	"TestStructWithMap":                {Id: 84, Name: "TestStructWithMap"},
	"UInt":                             {Id: 85, Name: "UInt"},
	"UInt16":                           {Id: 86, Name: "UInt16"},
	"UInt16?":                          {Id: 87, Name: "UInt16?"},
	"UInt64":                           {Id: 88, Name: "UInt64"},
	"UInt64?":                          {Id: 89, Name: "UInt64?"},
	"UInt?":                            {Id: 90, Name: "UInt?"},
	"Unit":                             {Id: 91, Name: "Unit"},
}
