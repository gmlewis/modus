...
var wantTestsuiteTypes = metadata.TypeMap{
	...
	"Array[Int]":                {Id: 7, Name: "Array[Int]"},
	"Array[Int]?":               {Id: 8, Name: "Array[Int]?"},
	"Array[Person]":             {Id: 9, Name: "Array[Person]"},
	"Array[String]":             {Id: 10, Name: "Array[String]"},
	"Array[String]?":            {Id: 11, Name: "Array[String]?"},
	"Bool":                      {Id: 12, Name: "Bool"},
	"Byte":                      {Id: 13, Name: "Byte"},
	"Char":                      {Id: 14, Name: "Char"},
	"Double":                    {Id: 15, Name: "Double"},
	"FixedArray[Double]":        {Id: 16, Name: "FixedArray[Double]"},
	"FixedArray[Int64]":         {Id: 17, Name: "FixedArray[Int64]"},
	"FixedArray[UInt64]":        {Id: 18, Name: "FixedArray[UInt64]"},
	"Float":                     {Id: 19, Name: "Float"},
	"Int":                       {Id: 20, Name: "Int"},
	"Int16":                     {Id: 21, Name: "Int16"},
	"Int64":                     {Id: 22, Name: "Int64"},
	"Map[String, String]":       {Id: 23, Name: "Map[String, String]"},
	...
	"String":       {Id: 26, Name: "String"},
	"String!Error": {Id: 27, Name: "String!Error"},
	"String?":      {Id: 28, Name: "String?"},
	"TimeZoneInfo": {
		Id:   29,
		Name: "TimeZoneInfo",
		Fields: []*metadata.Field{
	...
	"UInt":   {Id: 31, Name: "UInt"},
	"UInt16": {Id: 32, Name: "UInt16"},
	"UInt64": {Id: 33, Name: "UInt64"},
}
