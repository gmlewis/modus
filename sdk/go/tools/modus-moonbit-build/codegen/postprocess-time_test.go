// -*- compile-command: "go test -run ^TestTestablePostProcess_Time ."; -*-
...
func TestTestablePostProcess_Time(t *testing.T) {
	...
	wg := &postProcessDiffs{
		...
		wantPostProcessHeader: wantTimePostProcessHeader,
...
var wantTimePostProcessHeader = `// Code generated by modus-moonbit-build. DO NOT EDIT.
