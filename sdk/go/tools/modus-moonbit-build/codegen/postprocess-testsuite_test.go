// -*- compile-command: "NO_COLOR=1 go test -run ^TestTestablePostProcess_Testsuite ."; -*-
...
func TestTestablePostProcess_Testsuite(t *testing.T) {
	...
	wg := &postProcessDiffs{
		wantPostProcessBody:   wantTestsuitePostProcessBody,
		gotPostProcessBody:    body.String(),
		wantPostProcessHeader: postProcessHeader + wantTestsuitePostProcessHeader,
		gotPostProcessHeader:  header.String(),
	}
	reportPostProcessDiffs(t, "testsuite", wg)
}

var wantTestsuitePostProcessBody = `
///|
pub fn read_map(
...
var wantTestsuitePostProcessHeader = `
///|
