// -*- compile-command: "go test -run ^TestTestablePostProcess_Neo4j ."; -*-
...
func TestTestablePostProcess_Neo4j(t *testing.T) {
	...
	wg := &postProcessDiffs{
		...
		wantPostProcessHeader: wantNeo4jPostProcessHeader,
...
var wantNeo4jPostProcessHeader = `// Code generated by modus-moonbit-build. DO NOT EDIT.
